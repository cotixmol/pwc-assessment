...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('SOYBEAN', 'WHEAT', 'SUNFLOWER', 'CORN', 'SORGHUM', name='croptype'), nullable=False),
    ...
    sa.Column('producer_id', sa.Integer(), nullable=False),
    sa.Column('crop_type', sa.Enum('SOYBEAN', 'WHEAT', 'SUNFLOWER', 'CORN', 'SORGHUM', name='croptype'), nullable=False),
